...
@section('content')
 <!-- rts breadcrumb area -->
    ...
    <div class="rts-clients-feedback rts-section-gap bg-feedback-about bg_image">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                                    ...
                                    <div class="feedback-about-swiper-wrapper">
                                        <div class="single-feedback-about">
                                            <div class="head">
                                                ...
                                                <div class="info">
                                                    <h5 class="title">Alex Doremon</h5>
                                                    <span>Manager, IIT Docs</span>
                                                </div>
                                            </div>
                                            <div class="body">
                                                <p>“Cleaning company a busiess provides cleaning services to individuals, businesses or organizations. Cleaning ofal services can include tasks”</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cpmpay-story-single-about">
                        ...
                        <div class="body">
                            ...
                            <a href="blog-details.html" class="rts-btn btn-border radious-0">
                                Read Details<i class="fa-regular fa-arrow-up-right"></i>
                            </a>
                        </div>
                    </div>
                    <!-- company story end -->
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cpmpay-story-single-about">
                        ...
                        <div class="body">
                            ...
                            <a href="blog-details.html">
                                <h5 class="title">All man faucibus vitae tempor primis auctor</h5>
                            </a>
                            <a href="blog-details.html" class="rts-btn btn-border radious-0">
                                Read Details<i class="fa-regular fa-arrow-up-right"></i>
                            </a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cpmpay-story-single-about">
                        ...
                        <div class="body">
                            ...
                            <a href="blog-details.html">
                                <h5 class="title">Future and faucibus vitae tempor primis auctor</h5>
                            </a>
                            <a href="blog-details.html" class="rts-btn btn-border radious-0">
                                Read Details<i class="fa-regular fa-arrow-up-right"></i>
                            </a>
